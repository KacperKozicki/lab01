...
function Lab4Edit({ itemToEdit, onClose = () => {} }) {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto bg-dark rounded-lg shadow-lg">
      {/* Header */}
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold">{formData.car || "Car Details"}</h2>
          <p className="text-gray-500">{formData.registration || "Registration Number"}</p>
        </div>
      </div>
